...
const TOKEN_KEY = "jm_recruiter_token";
const USER_KEY = "jm_recruiter_user";
...
export const api = {
  ...
  isRole(role: string) { return getUser()?.role === role; },
};

export const DEMO = { email: "recruiter@jobdozo.in", password: "recruiter123" };
