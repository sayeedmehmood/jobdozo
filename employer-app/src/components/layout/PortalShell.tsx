...
function ShellInner({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="portal-shell employer-shell">
      ...
      <div className="portal-main">
        ...
        <main className="portal-content" id="main-content">
          <div className="page-head">
            <div>
              <h1>{pathname === "/dashboard" ? `Welcome, ${user?.company || user?.name || "Employer"}` : title}</h1>
              <Breadcrumbs />
            </div>
            <div className="page-head-actions">
              <Link href="/jobs" className="btn-primary"><i className="fa-solid fa-plus" /> Post Job</Link>
